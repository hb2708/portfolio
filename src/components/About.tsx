      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-16 items-start mb-24">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-text mb-12 flex items-center">
              <span className="text-primary mr-2">
                {ABOUT_CONTENT.sectionTitle.number}
              </span>{' '}
              {ABOUT_CONTENT.sectionTitle.text}
            </h2>
            <h3 className="text-2xl font-bold text-text mb-6">
              {ABOUT_CONTENT.role.title}
              <span className="text-primary">
                {ABOUT_CONTENT.role.highlight}
              </span>
            </h3>
            <p className="text-muted mb-6 leading-relaxed text-lg">
              {ABOUT_CONTENT.intro[0].text}
              <span className="text-text font-medium">
                {ABOUT_CONTENT.intro[0].highlight1}
              </span>
              {ABOUT_CONTENT.intro[0].text2}
              <span className="text-text font-medium">
                {ABOUT_CONTENT.intro[0].highlight2}
              </span>
              {ABOUT_CONTENT.intro[0].text3}
            </p>
            <p className="text-muted mb-6 leading-relaxed text-lg">
              {ABOUT_CONTENT.intro[1].text}
              <span className="text-text font-medium">
                {ABOUT_CONTENT.intro[1].highlight}
              </span>
              {ABOUT_CONTENT.intro[1].text2}
            </p>
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-text mb-6">
              {ABOUT_CONTENT.leadership.title}
            </h3>
        ...
        >
          <h3 className="text-2xl font-bold text-text mb-8 text-center">
            {ABOUT_CONTENT.pillars.title}
            <span className="text-primary">
              {ABOUT_CONTENT.pillars.highlight}
            </span>
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex flex-col items-start gap-4 p-6 bg-surface rounded-xl border border-text/5 hover:border-primary/30 transition-all hover:-translate-y-1">
              ...
              <div>
                <h4 className="text-text font-bold mb-2 text-lg">
                  {ABOUT_CONTENT.pillars.items[0].title}
                </h4>
                <p className="text-muted text-sm leading-relaxed">
                  {ABOUT_CONTENT.pillars.items[0].description}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-start gap-4 p-6 bg-surface rounded-xl border border-text/5 hover:border-primary/30 transition-all hover:-translate-y-1">
              ...
              <div>
                <h4 className="text-text font-bold mb-2 text-lg">
                  {ABOUT_CONTENT.pillars.items[1].title}
                </h4>
                <p className="text-muted text-sm leading-relaxed">
                  {ABOUT_CONTENT.pillars.items[1].description}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-start gap-4 p-6 bg-surface rounded-xl border border-text/5 hover:border-primary/30 transition-all hover:-translate-y-1">
              ...
              <div>
                <h4 className="text-text font-bold mb-2 text-lg">
                  {ABOUT_CONTENT.pillars.items[2].title}
                </h4>
                <p className="text-muted text-sm leading-relaxed">
                  {ABOUT_CONTENT.pillars.items[2].description}
                </p>
              </div>
            </div>
          </div>
        ...
        >
          <h3 className="text-2xl font-bold text-text mb-8 text-center">
            {ABOUT_CONTENT.valueProps.title}
            <span className="text-primary">
              {ABOUT_CONTENT.valueProps.highlight}
            </span>
          </h3>
        </motion.div>
