  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        <Link
          to="/"
          className="text-2xl font-bold text-text hover:text-primary transition-colors z-50 font-display tracking-tighter"
        >
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <a
            ...
            onClick={() =>
              trackEvent('RESUME_DOWNLOAD', { label: 'Desktop Nav' })
            }
        ...
        <button
          ...
          aria-label={
            isMobileMenuOpen
              ? NAVBAR_CONTENT.mobileMenu.close
              : NAVBAR_CONTENT.mobileMenu.open
          }
          ...
          >
            <div className="flex flex-col px-6 py-8 space-y-6">
              ...
              <a
                ...
                onClick={() => {
                  setIsMobileMenuOpen(false)
                  trackEvent('RESUME_DOWNLOAD', { label: 'Mobile Nav' })
                }}
