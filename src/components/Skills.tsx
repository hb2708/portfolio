    ...
    return (
        <section id="skills" className="py-24 md:py-32 bg-background">
            <div className="container mx-auto px-6">
                ...
                >
                    <span className="text-primary mr-2">{SKILLS_CONTENT.sectionTitle.number}</span> {SKILLS_CONTENT.sectionTitle.text}
                </motion.h2>

                {/* Featured Skills */}
                <div className="mb-16">
                    <h3 className="text-xl font-bold text-text mb-8">{SKILLS_CONTENT.coreExpertise}</h3>
                ...
                >
                    <h3 className="text-xl font-bold text-text mb-6">{SKILLS_CONTENT.alsoProficientIn}</h3>
