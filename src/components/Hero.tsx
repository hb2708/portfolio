                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
                    ...
                    <div className="flex-1 text-center lg:text-left animate-slide-in-left">
                        ...
                        <div className="text-xl md:text-2xl text-muted mb-8 font-mono animate-fade-in [animation-delay:300ms]">
                            {HERO_CONTENT.subHeading.first} <span className="text-primary">{HERO_CONTENT.subHeading.connector || '&'}</span> {HERO_CONTENT.subHeading.second}
                        ...
                        <p className="text-lg text-muted mb-10 max-w-xl leading-relaxed mx-auto lg:mx-0 animate-fade-in [animation-delay:500ms]">
                            {HERO_CONTENT.intro.prefix} <span className="text-text font-semibold border-b border-primary">{HERO_CONTENT.intro.highlight}</span>{HERO_CONTENT.intro.suffix}
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start mb-12 animate-slide-in-up [animation-delay:700ms]">
                            <a
                                href="#projects"
                                onClick={() => trackEvent('CTA_CLICK', { action: 'View Projects', label: 'Hero Section' })}
                            ...
                            <a
                                href="#contact"
                                onClick={() => trackEvent('CTA_CLICK', { action: 'Contact Me', label: 'Hero Section' })}
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-8 text-muted animate-fade-in [animation-delay:900ms]">
                            <a href={SOCIAL_LINKS.github.url} target="_blank" rel="noopener noreferrer" aria-label="Visit GitHub Profile" onClick={() => trackEvent('SOCIAL_LINK_CLICK', { action: 'GitHub', label: 'Hero Section' })} className="flex items-center justify-center w-12 h-12 rounded-full bg-white/5 border border-white/10 text-muted hover:bg-primary/10 hover:border-primary/50 hover:text-primary transition-all duration-300 hover:scale-110">
...
const StatItem = memo(({ number, label, context }: StatItemProps) => (
    <div className="text-center group relative">
        <div className="text-4xl md:text-5xl font-bold text-white mb-2 font-display tracking-tighter">{number}</div>
