        ...
        <div className="min-h-screen bg-background pt-24 pb-20">
            <div className="container mx-auto px-6">
                ...
                >
                    <div className="order-2 lg:order-1">
                        ...
                        <div className="flex flex-wrap gap-3 mb-8">
                            {project.tech.map((t) => (
                                <span key={t} className="px-3 py-1 bg-primary/10 text-primary rounded-full text-sm font-mono border border-primary/20">
                                    {t}
                                </span>
                            ))}
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
                    ...
                    >
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-text">Technical Solutions</h2>
                        </div>
                        <ul className="space-y-4">
                ...
                <motion.div
                    ...
                    className="mb-20"
                >
                    <h2 className="text-3xl font-bold text-text mb-8 text-center">Key Features</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {project.features?.map((feature, index) => (
                            <div key={index} className="bg-surface p-6 rounded-xl border border-white/5 text-center hover:border-primary/30 transition-colors">
