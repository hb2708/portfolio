        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-muted leading-relaxed mb-4">
              Recognized by the CEO at MoneyLion for exceptional dedication and
              impact. This award highlights contributions that go beyond code,
              fostering a culture of excellence and resilience.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-muted leading-relaxed mb-4">
              ...
              , significantly improving team velocity and code quality.
              Spearheaded initiatives to refine hiring processes and onboarding
              excellence.
            </p>
          </motion.div>
        </div>
