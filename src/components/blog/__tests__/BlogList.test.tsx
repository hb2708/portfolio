...
describe('BlogList Component', () => {
    it('renders the blog header and description', () => {
        ...
        expect(screen.getByText(/Thoughts on mobile engineering/i)).toBeInTheDocument()
    })
    ...
    it('shows empty state when no posts match', async () => {
        ...
        expect(screen.getByText(/No articles found matching your search/i)).toBeInTheDocument()
    })
})
