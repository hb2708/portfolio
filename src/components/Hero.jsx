            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                    ...
                    >
                        ...
                        >
                            <a href="https://github.com/hb2708" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors hover:scale-110 transform duration-200 focus:ring-2 focus:ring-primary focus:outline-none rounded-full">
                                <Github className="w-6 h-6" />
                            </a>
                            <a href="https://linkedin.com/in/harshal-ios-swift-react-native" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors hover:scale-110 transform duration-200 focus:ring-2 focus:ring-primary focus:outline-none rounded-full">
                                <Linkedin className="w-6 h-6" />
                            </a>
                            <a href="mailto:hb2708@gmail.com" className="hover:text-primary transition-colors hover:scale-110 transform duration-200 focus:ring-2 focus:ring-primary focus:outline-none rounded-full">
...
const StatItem = ({ number, label, context }) => (
