...
const SEO = ({
    ...
    const siteTitle = 'Harshal Bhavsar | Staff Engineer, iOS & React Native Expert'
    const siteDescription = 'Portfolio of Harshal Bhavsar, a Staff Engineer and Mobile Specialist with 10+ years of experience building scalable apps.'
